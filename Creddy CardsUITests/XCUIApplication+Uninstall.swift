...
// This was pulled from https://www.jessesquires.com/blog/2021/10/25/delete-app-during-ui-tests/
// I just wanted a nicer way to clean slate without #if UITEST type mess
extension XCUIApplication {
    func uninstall(name: String? = nil) async {
        Task { @MainActor in
            self.terminate()
